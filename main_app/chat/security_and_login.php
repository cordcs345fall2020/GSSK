 ...
 <?php 
  ?>
			...
			<form id="form1" name="form1" enctype="multipart/form-data" action="" method="POST">
				...
				<label hidden id="textbox1label" class="contact_form_label" name="textbox1label" for="first_name">First Name:</label>
				<input hidden type="text" id="first_name" name="first_name" value="<?php echo($result[0]["first_name"]); ?>">
				

				<label hidden id="textbox1label" class="contact_form_label" name="textbox1label" for="last_name">Last Name:</label>
